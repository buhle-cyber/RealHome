            ...
            >
              ...
              <div className='flex flex-col item-center'>
                ...
                onClick={() => handleListingDelete(listing._id)}
                  className='text-red-700 border-red-700 bg-transparent hover:bg-red-700 hover:text-white uppercase py-2 px-4'
                >
                  Delete
                </button>
                <Link to={`/update-listing/${listing._id}`}>
                <button className='text-green-700 border-green-700 bg-transparent hover:bg-green-700 hover:text-white uppercase py-2 px-4'>Edit</button>
                </Link>
              </div>
            </div>
          ))}
